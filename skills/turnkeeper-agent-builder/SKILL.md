...
Treat all `0.1.0-alpha.3` surfaces as prerelease. Do not claim that Turnkeeper executes customer
...
```sh
npx @turnkeeper/cli@0.1.0-alpha.3 init ./my-agent
npx @turnkeeper/cli@0.1.0-alpha.3 validate ./my-agent/turnkeeper/policies.json
npx @turnkeeper/cli@0.1.0-alpha.3 test-policies ./my-agent/turnkeeper/policies.json
