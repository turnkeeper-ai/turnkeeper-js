...
The package is prerelease at `0.1.0-alpha.7`.
...
{
  "command": "npx",
  "args": ["-y", "@turnkeeper/mcp@0.1.0-alpha.7"],
  "env": {
...
- Run the published package with `npx -y @turnkeeper/mcp@0.1.0-alpha.7`, or build this monorepo and
