...
| ------------- | ------------------ | ------------------- |
| 0.1.0-alpha.7 | 2026-07-27         | self_hosted Replay provider prerelease |
...
- Prefer exact versions such as `@turnkeeper/sdk@0.1.0-alpha.7` in application manifests and
