...
if (packageJson.name !== "@turnkeeper/adapter-sentinel") {
  throw new Error("Package name must be @turnkeeper/adapter-sentinel.");
}
if (packageJson.private === true) throw new Error("The public adapter package must not be private.");
if (packageJson.license !== "Apache-2.0") throw new Error("The adapter must use Apache-2.0.");
if (packageJson.dependencies && Object.keys(packageJson.dependencies).length > 0) {
  throw new Error("adapter-sentinel must remain zero-dependency.");
}
