...
export function releaseChangelogDraft(tag) {
  ...
  return {
    content: [
      `Published @turnkeeper/sdk and @turnkeeper/adapter-sentinel at ${version} on the npm next channel.`,
    ...
    summary: `Ward SDK and adapter-sentinel ${version} are available on the npm next channel with provenance.`,
