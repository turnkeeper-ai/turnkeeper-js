...
test("release changelog copy is deterministic, bounded, and exact-versioned", () => {
  assert.deepEqual(releaseChangelogDraft("v0.1.0-alpha.6"), {
    content: [
      "Published @turnkeeper/sdk and @turnkeeper/adapter-sentinel at 0.1.0-alpha.6 on the npm next channel.",
    ...
    summary:
      "Ward SDK and adapter-sentinel 0.1.0-alpha.6 are available on the npm next channel with provenance.",
